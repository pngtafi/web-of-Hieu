    ...
    render() {
        return (
            <div id='footer'>
                ...
                <Container
                    leftContent={[
                        <h4 >We love crafting unforgettable digital experiences, brands and websites with people like you.</h4>,
                        <table style={{ borderCollapse: 'collapse', width: '100%', margin: '20px 30px', textAlign: 'left' }}>
